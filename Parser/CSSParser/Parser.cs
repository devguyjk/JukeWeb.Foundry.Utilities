...
namespace JukeWeb.Foundry.Utilities.Parser.CSSParser
{
	public class Parser {
		...
		void simpleselector(out SimpleSelector ss) {
			...
			ss.ElementName = "";
			string psd = null;
            JukeWeb.Foundry.Utilities.Parser.CSSParser.Attribute atb = null;
		...
		void attrib(out JukeWeb.Foundry.Utilities.Parser.CSSParser.Attribute atb) {
			atb = new JukeWeb.Foundry.Utilities.Parser.CSSParser.Attribute();
			atb.Value = "";
			string quote = null;
			string ident = null;
