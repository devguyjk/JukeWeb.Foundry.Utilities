...
namespace JukeWeb.Foundry.Utilities.Parser.CSSParser {
	...
	public class SimpleSelector {
		...
		public override string ToString() {
			/*
simpleselector<out SimpleSelector ss> =		(. ss = new SimpleSelector(); string psd = null; JukeWeb.Foundry.Utilities.Parser.CSSParser.Attribute atb = null; SimpleSelector parent = ss; .)
			...
			*/
			...
			if (combinator.HasValue) {
				switch (combinator.Value) {
					case JukeWeb.Foundry.Utilities.Parser.CSSParser.Combinator.PrecededImmediatelyBy: txt.Append(" + "); break;
					case JukeWeb.Foundry.Utilities.Parser.CSSParser.Combinator.ChildOf: txt.Append(" > "); break;
					case JukeWeb.Foundry.Utilities.Parser.CSSParser.Combinator.PrecededBy: txt.Append(" ~ "); break;
				}
			}
